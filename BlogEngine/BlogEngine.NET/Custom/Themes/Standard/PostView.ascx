    ...
    <header class="post-header">
        ...
        <div class="post-info clearfix">
            ...
            <a rel="nofollow" href="<%=Post.RelativeOrAbsoluteLink %>#comment">
                <i class="fa fa-comments"></i> <span class="disqus-comment-count" data-disqus-url="<%=Post.AbsoluteLink %>"></span> 
			</a>
			...
			<a rel="nofollow" href="<%=Post.RelativeOrAbsoluteLink %>#comment">
                <i class="fa fa-comments"></i> <span class="fb-comments-count" data-href="<%=Post.AbsoluteLink %>"></span>
			</a>
            ...
            <%} else {%>
            <a rel="nofollow" href="<%=Post.RelativeOrAbsoluteLink %>#comment">
                <i class="fa fa-comments"></i> Comments (<%=Post.ApprovedComments.Count %>)
            </a>
            <%} %>
        </div>
    </header>
